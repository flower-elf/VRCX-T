...
pub fn get_registry_key(key: &str) -> Result<serde_json::Value, AppError> {
    let _ = key;
...
pub fn get_registry_key_string(key: &str) -> Result<String, AppError> {
    let val = get_registry_key(key)?;
    Ok(val.as_str().unwrap_or("").to_string())
}

pub fn has_registry_folder() -> Result<bool, AppError> {
    #[cfg(target_os = "windows")]
    {
        use winreg::enums::*;
        use winreg::RegKey;
...
pub fn delete_registry_folder() -> Result<(), AppError> {
    #[cfg(target_os = "windows")]
    {
        use winreg::enums::*;
        use winreg::RegKey;
...
pub fn set_registry_key(
    ...
    #[cfg(target_os = "linux")]
    {
        return crate::domain::linux_registry::set_registry_key(key, value, type_int)
...
pub fn get_registry() -> Result<HashMap<String, HashMap<String, serde_json::Value>>, AppError> {
    #[cfg(target_os = "windows")]
    {
        use winreg::enums::*;
        use winreg::RegKey;
...
pub fn set_registry(json: &str) -> Result<(), AppError> {
    let _ = json;
    ...
    #[cfg(target_os = "linux")]
    {
        return crate::domain::linux_registry::set_registry(json).map_err(AppError::Custom);
    }
    #[cfg(not(any(target_os = "windows", target_os = "linux")))]
    {
        Ok(())
...
pub fn read_reg_json_file(filepath: &str) -> Result<String, AppError> {
